...
Your challenge is to build a weather dashboard application that calls the Weather.gov API and renders data in the browser.
...
* Use the [Weather.gov API](https://www.weather.gov/documentation/services-web-api) to retrieve weather data for cities.
...
* For more information on how to work with the Weather.gov API, refer to the [Weather.gov API documentation](https://www.weather.gov/documentation/services-web-api).
...
* Using the Weather.gov API, you'll notice that you'll need to pass in coordinates instead of just a city name. Using the Weather.gov APIs, how could we retrieve geographical coordinates given a city name?

* How could we make the Weather.gov API calls server-side, parse the data, and then send the parsed data client-side?
...
* Application uses the Weather.gov API to retrieve weather data.
